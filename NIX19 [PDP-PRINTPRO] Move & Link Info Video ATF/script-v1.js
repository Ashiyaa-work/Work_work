(() => {
  'use strict';
  const testInfo = {
    className: 'nix-19-test',
    debug: 0,
    testName: 'NIX19: [PDP-PRINTPRO] Move & Link Info Video ATF',
    testVersion: '0.0.1'
  };
  ...
  const loadTest = () => {
    ...
    waitForElement('.vc_row.wpb_row.vc_row-fluid.vc_row-has-fill .wpb_column.vc_column_container').then(() => {
      const video_html = `<div class="video_container text">
        ...
        <p class="video_anchor">Learn more about the Nix Print Pro</p>
      </div>
      <div class="popup-overlay" id="videoPopup">
        <div class="popup-content">
          ...
          <iframe src="https://player.vimeo.com/video/877485297?badge=0&autopause=0&quality_selector=1&progress_bar=1&player_id=0&app_id=58479" target="_blank" title="description" allow="autoplay; fullscreen"></iframe>
        </div>
      </div>`;
      ...
      const classAllocations = (selector,prefix) => {
        ...
        document.querySelectorAll(selector).forEach((e) => {
            ...
            sectionIndex++;
			 ...
			 classAllocations('.wpb-content-wrapper .wpb_column .wpb_column','section');
