(() => {
  ...
  const secondAccouncement = `<div class="secondary-bar"><p>Get a smooth gliding shave with no bumps | <a href="https://groomhere.co.uk/products/women-shaver">Shop Women Shaver</a></p></div>`;
  const loadTest = () => {
